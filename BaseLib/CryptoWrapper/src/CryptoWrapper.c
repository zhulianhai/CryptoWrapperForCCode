...
int CreateSecretKeySM2(unsigned char* public_key, const int public_buffer_len,   int *pubKey_len, unsigned char* prive_key, const int prive_buffer_len, int *privekey_len)
{
